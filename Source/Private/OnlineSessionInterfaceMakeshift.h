 ...
 */
class FOnlineSessionMakeshift : public IOnlineSession
{
private:
	 ...
	 */
	void AppendSessionToPacket(class FNboSerializeToBufferMakeshift& Packet, class FOnlineSession* Session);
	 ...
	 */
	void AppendSessionSettingsToPacket(class FNboSerializeToBufferMakeshift& Packet, FOnlineSessionSettings* SessionSettings);
	 ...
	 */
	void ReadSessionFromPacket(class FNboSerializeFromBufferMakeshift& Packet, class FOnlineSession* Session);
	 ...
	 * @param SessionSettings the session settings to copy the data to
	 */
	void ReadSettingsFromPacket(class FNboSerializeFromBufferMakeshift& Packet, FOnlineSessionSettings& SessionSettings);
	 ...
	 */
	static void SetPortFromNetDriver(const FOnlineSubsystemMakeshift& Subsystem, const TSharedPtr<FOnlineSessionInfo>& SessionInfo);
...
PACKAGE_SCOPE:
	...
	FOnlineSessionMakeshift(class FOnlineSubsystemMakeshift* InSubsystem) :
...
public:
	...
	virtual ~FOnlineSessionMakeshift() {}
...
typedef TSharedPtr<FOnlineSessionMakeshift, ESPMode::ThreadSafe> FOnlineSessionMakeshiftPtr;
